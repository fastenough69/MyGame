...
Objects::Object::Object(std::shared_ptr<Render::ProgramShader> pr, Sprite::SpriteSize &sz, glm::vec2 &pos,
...
void Objects::Object::add_state(const std::string name, std::shared_ptr<Render::Texture2D> tex,
