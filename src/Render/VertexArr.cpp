...
void Render::VertexArr::add_buffer(const VertexBuffArr &vbo, int size, GLenum type, GLboolean norm, GLsizei stride,
                                   const void *ptr)
{
    bind();
...
void Render::VertexArr::add_buffer(IndexBuff &emo, int size, GLenum type, GLboolean norm, GLsizei stride,
                                   const void *ptr)
{
    bind();
    glEnableVertexAttribArray(index_buffers);
